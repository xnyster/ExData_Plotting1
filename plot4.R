# Code for plot 4: Four different time series graphs
...
# Change parameter to plot 4 graphs
par(mfrow = c(2,2))

# Plot the 1st graph
plot(timedata, as.numeric(as.character(data$Global_active_power)), type="l", ylab = "Global Active Power", xlab = "")

# Plot the 2nd graph
plot(timedata, as.numeric(as.character(data$Voltage)), type="l", ylab = "Voltage", xlab = "datetime")
...
# Plot the 4th graph
plot(timedata, as.numeric(as.character(data$Global_reactive_power)), type="l", ylab = "Global_reactive_power", xlab = "datetime")
